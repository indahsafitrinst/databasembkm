    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="/ubahpengumuman" method="POST">
          @csrf
          <input type="text" hidden name="idpengumuman" value="{{$datapengumuman->id_pengumuman}}">
          <div class="mb-3">
            <label for="judulpengumuman" class="form-label">Judul : </label>
            <input name="judulpengumuman" id="judulpengumuman" type="text" class="form-control" value="{{$datapengumuman->judul}}">
          </div>
          <div class="mb-3">
            <label for="isipengumuman" class="form-label">Isi Pengumuman : </label>
            <textarea name="isipengumuman" class="form-control" id="isipengumuman">{{$datapengumuman->isi_pengumuman}}</textarea>
          </div>
          <div class="mb-3">
...
$("#cek2").show().delay(3000).fadeOut('slow', function(){
  window.location.replace("/daftarpengumuman/edit/{{$datapengumuman->id_pengumuman}}");
});
</script>
@endsection
