      ...
      <div class="col">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route('mitra.store') }}" class="needs-validation" novalidate>
                @csrf
                <div class="form-group">
                  <label for="kode_mitra" class="form-label">Kode Mitra</label>
                  <input name="kode_mitra" type="text" id="kode_mitra" class="form-control" placeholder="Masukkan Kode Mitra" required>
                  <div class="invalid-feedback">Harus masukkan Kode Mitra</div>
                </div>
                <div class="form-group">
                  <label for="nama_mitra" class="form-label">Nama Mitra</label>
                  <input name="nama_mitra" type="text" id="nama_mitra" class="form-control" placeholder="Masukkan Nama Mitra" required>
