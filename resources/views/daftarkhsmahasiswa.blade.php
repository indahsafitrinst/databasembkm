...
<nav class="navbar navbar-light bg-light fixed-top navbar-expand-lg">
  <div class="container-fluid">
    ...
    <a class="nav-link tombolnavbar" href="/daftarkhsmahasiswa"><i class="bi bi-person-lines-fill me-2"></i>Daftar KRS</a>
    <a class="nav-link tombolnavbar" href="/daftarkrsmahasiswa"><i class="bi bi-postcard me-2"></i>Daftar KHS</a>
